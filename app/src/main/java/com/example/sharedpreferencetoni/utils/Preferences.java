package com.example.sharedpreferencetoni.utils;
...
import com.example.sharedpreferencetoni.model.UserModel;

public class Preferences {


    private static final String PREF_SESSION = "com.example.sharedpreferencetoni.session";
